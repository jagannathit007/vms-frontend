...
const Sidebar = ({ isOpen, toggleSidebar, currentPage, setCurrentPage, isMobile }) => {
  ...
  return (
    <>
      ...
      <div
        className="top-0 start-0 text-white shadow-lg"
        style={{
          minHeight: '100vh',
          width: isOpen ? (isMobile ? '280px' : '240px') : (isMobile ? '0' : '80px'),
          zIndex: 999,
      ...
      >
        ...
        >
          ...
          <button
            className={`btn text-white p-2 rounded ${!isOpen ? 'mx-auto' : ''}`}
            onClick={toggleSidebar}
            style={{
        ...
        <div className="p-3">
          {sidebarItems.map((item, index) => (
            <div
              ...
              className={`mb-2 d-flex align-items-center p-3 rounded position-relative ${
                currentPage === item.name ? 'active-item' : 'nav-item'
              }`}
              style={{
                cursor: 'pointer',
                transition: 'all 0.2s ease',
            ...
            >
              ...
              <span
                ...
                style={{
                  fontSize: '18px',
                  color: currentPage === item.name ? '#ffffff' : 'rgba(255, 255, 255, 0.8)',
                  minWidth: '18px',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
              ...
              {isOpen && (
                <span
                  className="ms-3"
                  style={{
                    color: currentPage === item.name ? '#ffffff' : 'rgba(255, 255, 255, 0.9)',
                    fontSize: '14px',
        ...
        {isOpen && (
          <div
            className="position-absolute bottom-0 start-0 end-0 p-3 text-center border-top"
            style={{
              borderColor: 'rgba(255, 255, 255, 0.1) !important',
